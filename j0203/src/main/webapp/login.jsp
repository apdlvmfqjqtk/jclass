			...
			<div id="contents">
				<div id="member">
					...
					<div class="informbox">
						<div class="inform">
							<ul>
								<li><input type="text" name="idinput" class="loginType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='loginType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
							...
							<div class="chk"><input type="checkbox" id="idsave" value="idsave"/><label for="idsave">아이디 저장</label></div>							
